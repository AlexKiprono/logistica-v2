...
const Sidenav = () => {
  ...
  return (
    <div>
      <aside className="fixed inset-y-0 xl:left-0 xl:ml-6 w-full max-w-64 bg-white shadow-xl border border-indigo-100 rounded-xl overflow-y-auto p-0 my-4">
        {/* Header */}
        <div className="px-6 py-6">
          <NavLink to="/" className="flex items-center">
            <span className="text-xl font-bold text-indigo-600">MATATU</span>
          </NavLink>
        </div>
        ...
        <nav className="px-4">
          <ul className="space-y-2 text-slate-700">
            ...
            <li className="group">
              <button
                onClick={() => toggleModal("station")}
                className="w-full flex items-center gap-3 p-2 rounded-md hover:bg-indigo-100"
              >
                <IconStation />
      ...
      {/* Modals */}
      {modals.station && (
        <Modal onClose={() => toggleModal("station")}>
          <CreateStations />
        </Modal>
      )}
      {modals.driver && (
        <Modal onClose={() => toggleModal("driver")}>
          <CreateDrivers />
        </Modal>
      )}
      {modals.vehicle && (
        <Modal onClose={() => toggleModal("vehicle")}>
          <CreateVehicles />
        </Modal>
      )}
      {modals.route && (
        <Modal onClose={() => toggleModal("route")}>
          <CreateRoutes />
        </Modal>
      )}
    </div>
...
const MenuItem = ({ to, iconClass, text }) => (
  <li>
    <NavLink
      to={to}
      className="flex items-center gap-3 px-4 py-2 rounded-md font-semibold hover:bg-indigo-100"
    >
      <i className={iconClass}></i>
      <span>{text}</span>
    </NavLink>
...
const IconStation = () => (
  ...
  >
    <path d="M7 14.4375C7 13.7471 7.55964 13.1875 8.25 13.1875C8.94036 13.1875 9.5001 13.7471 9.5001 14.4375C9.5001 15.1279 8.94046 15.6875 8.2501 15.6875C7.55974 15.6875 7 15.1279 7 14.4375Z" />
    <path d="M15.75 13.1875C15.0596 13.1875 14.5 13.7471 14.5 14.4375C14.5 15.1279 15.0596 15.6875 15.75 15.6875C16.4404 15.6875 17.0001 15.1279 17.0001 14.4375C17.0001 13.7471 16.4404 13.1875 15.75 13.1875Z" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M7.625 2.625C5.83293 2.625 4.33446 3.88206 3.96326 5.5625H3.875C3.04657 5.5625 2.375 6.23407 2.375 7.0625V7.8125C2.375 8.22671 2.71079 8.5625 3.125 8.5625H3.875V16.625C3.875 17.3498 4.21774 17.9946 4.75 18.4061V19.875C4.75 20.7034 5.42157 21.375 6.25 21.375C7.07843 21.375 7.75 20.7034 7.75 19.875V18.875H16.25V19.875C16.25 20.7034 16.9216 21.375 17.75 21.375C18.5784 21.375 19.25 20.7034 19.25 19.875V18.4061C19.7823 17.9946 20.125 17.3498 20.125 16.625V8.5625H20.875C21.2892 8.5625 21.625 8.22671 21.625 7.8125V7.0625C21.625 6.23407 20.9534 5.5625 20.125 5.5625H20.0367C19.6655 3.88206 18.1671 2.625 16.375 2.625H7.625Z"
    />
  </svg>
);
...
const IconDriver = () => (
  ...
  >
    <path
      ...
      strokeWidth={1.5}
      d="M18 7.5v6m-3-3h6M3 19.125v-.11a6.375 6.375 0 0 1 12.75 0v.11A12.318 12.318 0 0 1 9.375 21c-2.331 0-4.513-.645-6.375-1.766ZM14.625 7.5a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Z"
    />
  </svg>
);
...
const IconVehicle = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0h6m-9 0H3.375A1.125 1.125 0 0 1 2.25 17.625V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25V7.573c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0A1.106 1.106 0 0 0 2.25 7.573v7.635"
    />
  </svg>
);
