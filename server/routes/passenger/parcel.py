...
# @passenger_bp.route('/companies', methods=['GET'])
# def get_companies():
#     companies = Company.query.all()
#     return jsonify([{'id': c.id, 'name': c.name} for c in companies])

# @passenger_bp.route('/companies/<int:company_id>/counties', methods=['GET'])
...
# @passenger_bp.route('/companies/<int:company_id>/counties/<int:county_id>/stations', methods=['GET'])
...
# @passenger_bp.route('/send-parcel', methods=['POST'])
# @jwt_required()
# def send_parcel():
